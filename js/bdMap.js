...
function ShowMap(objname,options){
	if(options){
		...
		this._addr = options.addr ? options.addr : ""; 
		...
		this._zoom = options.zoom ? options.zoom : "14"; 
	}
	...
	if (this._ismove=="1"){
		...
		var label = new BMap.Label({offset:new BMap.Size(20,-15)});
	...
	if (this._ismove=="0"){
		...
		if (this._lawfirm !=""){infotxt += this._lawfirm + "<br/>";};
		if (this._addr !=""){infotxt += this._addr + "<br/>";};
		if (this._tel !=""){infotxt += this._tel + "<br/>";};
